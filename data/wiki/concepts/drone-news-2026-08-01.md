...
domain: ops-mission
sources: ["inbox/fetch-2026-08-01-rss-dronelife.md"]
confidence: high
contested: false
contradictions: []
---

# 드론 뉴스 다이제스트 (2026-08-01)

2026년 8월 1일 dronelife RSS 피드의 주요 드론 업계 소식.

## 주요 뉴스

### Ericsson, AT&T: 셀룰러 데이터로 드론 탐지
- FIFA 월드컵 및 미국 250주년 기념 행사 이후, 법 집행 기관과 인프라 소유자들이 공역 내 드론 식별 및 추적의 중요성 인식
- 셀룰러 데이터를 활용한 드론 탐지 기술

### Air India, SkyDrive, Suzuki: 의료 공중 물류 협력
- SkyDrive의 eVTOL 항공기를 활용한 인도 도시 내 응급 의료 물류 연구
- 2026년 7월 31일 MOU 체결
- 인도 주요 도시의 심각한 교통 혼잡 문제 해결 목표

### FAA 부국장 퇴임
- Chris Rocheleau 부국장이 FAA를 떠남
- BVLOS 규제 제정 작업 중 리더십 변화
- 2025년 1월 중공 충돌 사고 이후 가장 눈에 띄는 지도자 중 한 명

### EagleNXT: MicaSense RedEdge-MX 다중 스펙트럼 센서 재출시
- Texas에서 제조된 센서
- DLS 2 광 센서 지원 및 밀 농약 연구에 활용
- Allen, Texas 기반 AgEagle Aerial Systems (NYSE: UAVS)
